// ======================================================================
// UARTldr_QFN.v generated from TopDesign.cysch
// 04/30/2025 at 20:57
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("9fdd6243-3530-43f4-b4ed-644b9f893f5d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("d8f691f7-2714-4b6c-8ac3-6919709a77bd"),
    ...
    assign Net_590 = Net_412 ^ Net_14992;


    assign Net_13442 = Net_411 ^ Net_820;

    CyControlReg_v1_80 IVO_UART (
        .clock(1'b0),
        .control_0(Net_412),
        .control_1(Net_411),
        .control_2(Net_477),
        ...
        .control_7(Net_281),
        .reset(1'b0));
    defparam IVO_UART.Bit0Mode = 0;
    defparam IVO_UART.Bit1Mode = 0;
    defparam IVO_UART.Bit2Mode = 0;
    defparam IVO_UART.Bit3Mode = 0;
    defparam IVO_UART.Bit4Mode = 0;
    defparam IVO_UART.Bit5Mode = 0;
    defparam IVO_UART.Bit6Mode = 0;
    defparam IVO_UART.Bit7Mode = 0;
    defparam IVO_UART.BitValue = 0;
    defparam IVO_UART.BusDisplay = 0;
    defparam IVO_UART.ExtrReset = 0;
    defparam IVO_UART.NumOutputs = 4;


	cy_clock_v1_0
		#(.id("cec96e05-af9b-4f65-95da-24a4063e0126"),
	...
	cy_psoc3_pins_v1_10
		#(.id("3196447a-d7f5-4c9d-900b-54986dc77078"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("70134038-bc3a-48d9-a95d-cae3181831dd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__safe_net;
	wire [0:0] tmpIO_0__safe_net;
	wire [0:0] tmpINTERRUPT_0__safe_net;
	electrical [0:0] tmpSIOVREF__safe_net;
	...
	cy_psoc3_pins_v1_10
		...
		safe
		 (.oe(tmpOE__safe_net),
		  .y({1'b0}),
		  .fb({Net_206}),
		  .io({tmpIO_0__safe_net[0:0]}),
		  .siovref(tmpSIOVREF__safe_net),
		  .interrupt({tmpINTERRUPT_0__safe_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__safe_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- LUT led_lut start --
    if (1)
    begin : led_lut
        reg [3:0] tmp__led_lut_reg;
        wire [2:0] tmp__led_lut_ins;
        assign tmp__led_lut_ins = {Net_144,count[1],count[0]};
        always @(tmp__led_lut_ins)
        begin
            case (tmp__led_lut_ins)
                3'b000 :  tmp__led_lut_reg = 4'b1110;
                3'b001 :  tmp__led_lut_reg = 4'b1101;
                3'b010 :  tmp__led_lut_reg = 4'b1011;
                3'b011 :  tmp__led_lut_reg = 4'b0111;
                3'b100 :  tmp__led_lut_reg = 4'b0011;
                3'b101 :  tmp__led_lut_reg = 4'b1001;
                3'b110 :  tmp__led_lut_reg = 4'b1100;
                3'b111 :  tmp__led_lut_reg = 4'b0110;
            endcase
        end
        assign {Net_204,Net_147,Net_146,Net_142} = tmp__led_lut_reg;
    end
    // -- LUT led_lut end --

    BasicCounter_v1_0 led_counter (
        .clock(Net_123),
        .cnt(count[1:0]),
        .en(Net_156),
        .reset(Net_158));
    defparam led_counter.Width = 2;

    assign Net_156 = 1'h1;

    assign Net_158 = 1'h0;

    CyControlReg_v1_80 safe_state (
        .clock(1'b0),
        .control_0(Net_144),
        .control_1(Net_171),
        .control_2(Net_172),
        ...
        .control_7(Net_178),
        .reset(1'b0));
    defparam safe_state.Bit0Mode = 0;
    defparam safe_state.Bit1Mode = 0;
    defparam safe_state.Bit2Mode = 0;
    defparam safe_state.Bit3Mode = 0;
    defparam safe_state.Bit4Mode = 0;
    defparam safe_state.Bit5Mode = 0;
    defparam safe_state.Bit6Mode = 0;
    defparam safe_state.Bit7Mode = 0;
    defparam safe_state.BitValue = 0;
    defparam safe_state.BusDisplay = 0;
    defparam safe_state.ExtrReset = 0;
    defparam safe_state.NumOutputs = 1;

    CyStatusReg_v1_90 safe_reg (
        .clock(Net_191),
        .intr(Net_200),
        .status_0(Net_206),
        .status_1(1'b0),
        ...
        .status_7(1'b0),
        .status_bus(8'b0));
    defparam safe_reg.Bit0Mode = 0;
    defparam safe_reg.Bit1Mode = 0;
    defparam safe_reg.Bit2Mode = 0;
    defparam safe_reg.Bit3Mode = 0;
    defparam safe_reg.Bit4Mode = 0;
    defparam safe_reg.Bit5Mode = 0;
    defparam safe_reg.Bit6Mode = 0;
    defparam safe_reg.Bit7Mode = 0;
    defparam safe_reg.BusDisplay = 0;
    defparam safe_reg.Interrupt = 0;
    defparam safe_reg.MaskValue = 0;
    defparam safe_reg.NumInputs = 1;


	cy_clock_v1_0
		#(.id("beb38d69-64bf-4d17-bdc0-b64b7d012933"),
		  .source_clock_id("a56f9c63-f1c2-47a9-89c5-5e1b8f2b9254"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
		  .is_digital(1))
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_590 or Net_1002 or Net_1004)
        begin
            case (Net_1004)
                1'b0 :  tmp__mux_2_reg = Net_590;
                1'b1 :  tmp__mux_2_reg = Net_1002;
            endcase
        end
        assign Net_1003 = tmp__mux_2_reg;
    end
    // -- Mux end --

    // -- DFF Start --
    reg  cydff_13;
    always @(posedge Net_563)
    begin
        cydff_13 <= Net_15344;
    end
    assign Net_15300 = cydff_13;
    // -- DFF End --
    ...
    assign Net_15325 = Net_15344 ^ Net_15300;


    assign Net_1002 = Net_590 ^ Net_29;
    ...
    PWM_v3_30_2 Mantmr (
        ...
        .tc(Net_563),
        .trigger(Net_15325));
    defparam Mantmr.Resolution = 8;


	cy_clock_v1_0
		#(.id("33e404fb-619a-41ad-9ac4-e6a9ee234771"),
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_15344 or Net_15300 or Net_477)
        begin
            case (Net_477)
                1'b0 :  tmp__mux_1_reg = Net_15344;
                1'b1 :  tmp__mux_1_reg = Net_15300;
            endcase
        end
        assign Net_820 = tmp__mux_1_reg;
    end
    // -- Mux end --
