...
#define PWMB_UsingFixedFunction             (1u)
#define PWMB_DeadBandMode                   (0u)
#define PWMB_KillModeMinTime                (0u)
#define PWMB_KillMode                       (1u)
#define PWMB_PWMMode                        (0u)
#define PWMB_PWMModeIsCenterAligned         (0u)
#define PWMB_DeadBandUsed                   (0u)
#define PWMB_DeadBand2_4                    (0u)
...
#define PWMB_UseOneCompareMode              (1u)
...
**************************************/
#define PWMB_INIT_PERIOD_VALUE          (127u)
#define PWMB_INIT_COMPARE_VALUE1        (4u)
#define PWMB_INIT_COMPARE_VALUE2        (63u)
...
#define PWMB_DEFAULT_COMPARE1_MODE      (uint8)((uint8)2u <<  PWMB_CTRL_CMPMODE1_SHIFT)
