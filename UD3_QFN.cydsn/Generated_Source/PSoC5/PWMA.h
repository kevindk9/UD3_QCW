...
#define PWMA_UsingFixedFunction             (1u)
#define PWMA_DeadBandMode                   (0u)
#define PWMA_KillModeMinTime                (0u)
#define PWMA_KillMode                       (1u)
#define PWMA_PWMMode                        (0u)
#define PWMA_PWMModeIsCenterAligned         (0u)
#define PWMA_DeadBandUsed                   (0u)
#define PWMA_DeadBand2_4                    (0u)
...
#define PWMA_UseOneCompareMode              (1u)
...
**************************************/
#define PWMA_INIT_PERIOD_VALUE          (127u)
#define PWMA_INIT_COMPARE_VALUE1        (4u)
#define PWMA_INIT_COMPARE_VALUE2        (100u)
...
#define PWMA_DEFAULT_COMPARE2_MODE      (uint8)((uint8)2u <<  PWMA_CTRL_CMPMODE2_SHIFT)
#define PWMA_DEFAULT_COMPARE1_MODE      (uint8)((uint8)2u <<  PWMA_CTRL_CMPMODE1_SHIFT)
