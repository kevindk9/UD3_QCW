...
{
    uint8 staticBits = (Relay3_DR & (uint8)(~Relay3_MASK));
    Relay3_DR = staticBits | ((uint8)(value << Relay3_SHIFT) & Relay3_MASK);
}
...
{
	CyPins_SetPinDriveMode(Relay3_0, mode);
}
...
{
    return (Relay3_PS & Relay3_MASK) >> Relay3_SHIFT;
}
...
{
    return (Relay3_DR & Relay3_MASK) >> Relay3_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Relay3_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Relay3_0_INTR) != 0u) 
		{ 
			 Relay3_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Relay3_INTSTAT & Relay3_MASK) >> Relay3_SHIFT;
    }
