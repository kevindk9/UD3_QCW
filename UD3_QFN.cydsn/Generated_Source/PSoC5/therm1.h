...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the therm1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(therm1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in therm1_SetInterruptMode() function.
     *  @{
     */
        #define therm1_INTR_NONE      (uint16)(0x0000u)
        #define therm1_INTR_RISING    (uint16)(0x0001u)
        #define therm1_INTR_FALLING   (uint16)(0x0002u)
        #define therm1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define therm1_INTR_MASK      (0x01u) 
#endif /* (therm1__INTSTAT) */
...
/* SIO registers */
#if defined(therm1__SIO_CFG)
    #define therm1_SIO_HYST_EN        (* (reg8 *) therm1__SIO_HYST_EN)
    #define therm1_SIO_REG_HIFREQ     (* (reg8 *) therm1__SIO_REG_HIFREQ)
    #define therm1_SIO_CFG            (* (reg8 *) therm1__SIO_CFG)
    #define therm1_SIO_DIFF           (* (reg8 *) therm1__SIO_DIFF)
#endif /* (therm1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define therm1_0_INTTYPE_REG 		(* (reg8 *) therm1__0__INTTYPE)
#endif /* (therm1__INTSTAT) */
