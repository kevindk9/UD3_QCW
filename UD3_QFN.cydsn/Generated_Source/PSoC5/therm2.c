...
*
* \funcusage
*  \snippet therm2_SUT.c usage_therm2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet therm2_SUT.c usage_therm2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet therm2_SUT.c usage_therm2_Read  
*******************************************************************************/
...
* preferred therm2_Read() API because the 
* therm2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet therm2_SUT.c usage_therm2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: therm2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use therm2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - therm2_0_INTR       (First pin in the list)
    *  - therm2_1_INTR       (Second pin in the list)
    *  - ...
    *  - therm2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet therm2_SUT.c usage_therm2_SetInterruptMode
    *******************************************************************************/
    void therm2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & therm2_0_INTR) != 0u) 
		{ 
			 therm2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet therm2_SUT.c usage_therm2_ClearInterrupt
    *******************************************************************************/
