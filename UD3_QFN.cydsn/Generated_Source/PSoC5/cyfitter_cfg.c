...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)(0x480000B0u + CYAPP_ECC_OFFSET))

/* IDMUX Address: CYREG_IDMUX_DRQ_CTL0 Size (bytes): 6 */
#define BS_IDMUX_VAL ((const uint8 CYFAR *)(0x48001234u + CYAPP_ECC_OFFSET))

/* IDMUX_IRQ Address: CYREG_IDMUX_IRQ_CTL0 Size (bytes): 8 */
#define BS_IDMUX_IRQ_VAL ((const uint8 CYFAR *)(0x4800123Cu + CYAPP_ECC_OFFSET))

/* UDB_1_0_0_CONFIG Address: CYDEV_UCFG_B1_P2_U0_BASE Size (bytes): 128 */
#define BS_UDB_1_0_0_CONFIG_VAL ((const uint8 CYFAR *)(0x48001244u + CYAPP_ECC_OFFSET))
...
#define BS_IOPINS1_7_VAL ((const uint8 CYFAR *)(0x480012E8u + CYAPP_ECC_OFFSET))

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)(0x480012F0u + CYAPP_ECC_OFFSET))

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)(0x480012FCu + CYAPP_ECC_OFFSET))

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)(0x48001304u + CYAPP_ECC_OFFSET))

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)(0x4800130Cu + CYAPP_ECC_OFFSET))

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 12 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)(0x48001318u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM1 Address: CYREG_PHUB_CFGMEM1_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)(0x48001324u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM2 Address: CYREG_PHUB_CFGMEM2_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM2_VAL ((const uint8 CYFAR *)(0x48001328u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM6 Address: CYREG_PHUB_CFGMEM6_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM6_VAL ((const uint8 CYFAR *)(0x4800132Cu + CYAPP_ECC_OFFSET))
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x07CFu);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG5_CFG0), 0x1F3Fu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT0_AMUX, 0x21u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT2_AG, 0xE0u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT3_AMUX, 0x0A04u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT4_AMUX, 0x0808u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC0_SW4, 0x11u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW2, 0x06u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP1_SW0, 0x02u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP3_SW0, 0x02u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR1_SW0, 0xA0u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR1_SW3, 0x20u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP0_MX, 0x0117u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP3_MX, 0x0206u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0xC2u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW2, 0x0Cu);
...
uint8 CYXDATA * const CYCODE Therm_Mux__addrTable[6] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE Therm_Mux__maskTable[6] = {
	0x40u, 0x40u, 
	0x80u, 0x00u, 
	0x04u, 0x00u, 
};
...
*
*******************************************************************************/
void Therm_Mux_Set(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*Therm_Mux__addrTable[channel] |= Therm_Mux__maskTable[channel];
		channel++;
		*Therm_Mux__addrTable[channel] |= Therm_Mux__maskTable[channel];
	}
}
...
*
*******************************************************************************/
void Therm_Mux_Unset(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*Therm_Mux__addrTable[channel] &= (uint8)~Therm_Mux__maskTable[channel];
		channel++;
		*Therm_Mux__addrTable[channel] &= (uint8)~Therm_Mux__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE ADC_therm_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADC_therm_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ADC_therm_AMux_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void ADC_therm_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_therm_AMux__addrTable[channel] |= ADC_therm_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ADC_therm_AMux_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void ADC_therm_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_therm_AMux__addrTable[channel] &= (uint8)~ADC_therm_AMux__maskTable[channel];
	}
}
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P0_U0_CFG24), 0x0404C4C8u);

		/* B0_P1_U1_CFG24 Starting address: CYDEV_UCFG_B0_P1_U1_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P1_U1_CFG24), 0x44004B5Au);

		/* B0_P4_U0_CFG24 Starting address: CYDEV_UCFG_B0_P4_U0_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P4_U0_CFG24), 0x04044844u);

		/* B0_P4_U1_CFG24 Starting address: CYDEV_UCFG_B0_P4_U1_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P4_U1_CFG24), 0x04048884u);

		/* B0_P5_U1_CFG24 Starting address: CYDEV_UCFG_B0_P5_U1_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P5_U1_CFG24), 0x04044B44u);

		/* B0_P6_U0_CFG24 Starting address: CYDEV_UCFG_B0_P6_U0_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P6_U0_CFG24), 0x84044444u);

		/* B0_P7_U0_CFG24 Starting address: CYDEV_UCFG_B0_P7_U0_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P7_U0_CFG24), 0x04008884u);

		/* B0_P7_U1_CFG24 Starting address: CYDEV_UCFG_B0_P7_U1_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P7_U1_CFG24), 0x04048484u);

		/* B1_P4_U0_CFG24 Starting address: CYDEV_UCFG_B1_P4_U0_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B1_P4_U0_CFG24), 0x04084444u);

		/* B1_P4_U1_CFG24 Starting address: CYDEV_UCFG_B1_P4_U1_CFG24 */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B1_P4_U1_CFG24), 0x0B0B8488u);
